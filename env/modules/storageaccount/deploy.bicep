...
resource blobPrivateDnsZoneVnetLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
  ...
  name: '${blobPrivateDnsZone.name}-oemvnetlink-pe'
  location: 'global'
  properties: {
...
// Create the blob containers within the blobServices namespace
...
resource blobContainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2021-06-01' = {
  name: 'oemcontainer' // Replace 'containerName' with your desired container name
  parent: blobService
  properties: {
    publicAccess: 'None'
  }
